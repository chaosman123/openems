...
public interface DeyeSunHybrid
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		SET_REACTIVE_POWER(Doc.of(OpenemsType.INTEGER) //
				...
				.accessMode(AccessMode.WRITE_ONLY)), //
		SET_GRID_CHARGING_START_CAPACITY_POINT(Doc.of(OpenemsType.INTEGER) //
				.unit(Unit.PERCENT) //
				.accessMode(AccessMode.WRITE_ONLY)), //
		SET_TIME_OF_USE_SELLING(Doc.of(OpenemsType.INTEGER).unit(Unit.NONE).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_1_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_2_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_3_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_4_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_5_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_6_POWER(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_1_CAPACITY(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_2_CAPACITY(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_3_CAPACITY(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_4_CAPACITY(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_5_CAPACITY(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
		SET_SELL_MODE_6_CAPACITY(Doc.of(OpenemsType.INTEGER).unit(Unit.PERCENT).accessMode(AccessMode.READ_WRITE)),
